...
var configFileName = require('../config').MATMAN_CONFIG;

var getConfigFilePath = function getConfigFilePath(configPath) {
...
function _search(targetPath) {
  var currDir = targetPath || process.cwd();
  var isExist = true;
