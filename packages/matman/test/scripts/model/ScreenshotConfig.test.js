...
describe('check model/ScreenshotConfig.js', () => {
    describe('check constructor(opts, basePath, tag)', () => {
        ...
        const caseModuleFilePath = path.join(MATMAN_ROOT_PATH, './case_modules/page_baidu_index/basic-check.js');
        ...
        it('if opts is Boolean and tag is undefined', () => {
            expect(new ScreenshotConfig(matmanConfig, true, caseModuleFilePath)).to.eql({
                path: path.join(matmanConfig.screenshotPath, './page_baidu_index/basic-check_js/basic-check_js.png'),
                tag: undefined
            });
        });
        ...
        it('if opts is Boolean and tag is "mytag"', () => {
            expect(new ScreenshotConfig(matmanConfig, true, caseModuleFilePath, 'mytag')).to.eql({
                path: path.join(matmanConfig.screenshotPath, './page_baidu_index/basic-check_js/basic-check_js_mytag.png'),
                tag: 'mytag'
            });
        });
    ...
    describe('check getPathWithId(id)', () => {
        ...
        it('if opts is Boolean and tag is "mytag"', () => {
            expect(new ScreenshotConfig(matmanConfig, true, caseModuleFilePath, 'mytag').getPathWithId(1024)).to.equal(path.join(matmanConfig.screenshotPath, './page_baidu_index/basic-check_js/basic-check_js_mytag_1024.png'));
        });
