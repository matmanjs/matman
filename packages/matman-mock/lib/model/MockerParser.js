...
var MockerParser = function () {
  ...
  function MockerParser(opts) {
    (0, _classCallCheck3.default)(this, MockerParser);

    this.basePath = opts.basePath;
    this.matmanMockers = Array.isArray(opts.matmanMockers) ? [].concat((0, _toConsumableArray3.default)(opts.matmanMockers)) : [];
  ...
  (0, _createClass3.default)(MockerParser, [{
    key: 'getAllMocker',
