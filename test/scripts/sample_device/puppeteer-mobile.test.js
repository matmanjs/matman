...
const checkPage = require('../../../demo/sample_device/puppeteer-mobile');

describe('(puppeteer-mobile)百度首页：常规检查', function () {
  this.timeout(30000);
  ...
  describe('检查基本信息', function () {
    ...
    it('窗体宽度 height=667', function () {
      expect(data.height).to.equal(667);
    });
  });
});
