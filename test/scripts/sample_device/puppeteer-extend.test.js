...
const checkPage = require('../../../demo/sample_device/puppeteer-extend');

describe('(puppeteer-extend)百度首页：常规检查', function () {
  this.timeout(30000);
  ...
  describe('检查基本信息', function () {
    ...
    it('窗体宽度 width=333', function () {
      expect(data.width).to.equal(333);
    });
