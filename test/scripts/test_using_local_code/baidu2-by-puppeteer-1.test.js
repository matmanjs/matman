...
const checkPage = require('../../../demo/test_using_local_code/case_modules/page_baidu_index/baidu2-by-puppeteer');

describe('(baidu2-by-puppeteer)使用本地项目和mockstar: success_type_1', function () {
  this.timeout(30000);
