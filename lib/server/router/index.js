...
module.exports = function (source) {
  ...
  db.forEach(function (value, key) {
    ...
    var msg = 'Type of "' + key + '" (' + (typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) + ') ' + (_.isObject(source) ? '' : 'in ' + source) + ' is not supported. ' + 'Use objects or arrays of objects.';
