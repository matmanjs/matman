...
var HandlerParser = function () {
  ...
  HandlerParser.prototype.getHandleModuleResult = function getHandleModuleResult(route) {
    ...
    var reqInfoByRoute = this.getReqInfoByRoute(route);
    ...
    return (_fsHandler$handle = fsHandler.handle).getModuleResult.apply(_fsHandler$handle, [reqInfoByRoute.fullPath].concat(props)).then(function (data) {
      return {
        data: data,
        extra: reqInfoByRoute
      };
